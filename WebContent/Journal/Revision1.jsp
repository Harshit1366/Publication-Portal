      ...
      <li><a href="../logout"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>  
                     ...
                     <form method="post" action="#">
                       ...
                       %><input type="text" size= '31' placeholder="Type author's name or PCN no." name="search" value=<%=search %>><%} %>
                        ...
                        <input type="SUBMIT" size= '31' placeholder="Type author's name or PCN no." value="SEARCH"></p></form> 
                        <br>
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                              <%
                            	...
                            	int x=0;
                              if(search==null){
                            	  for(Journal j : adminJObjs.getRev1Employees()){
                            		  x++;%>
                                  <tr>
                                      <td>
                                          <%=x%>
				...
				<%} %>
                            	  ...
                            	  //String search=request.getParameter("search");
                            	  for(Journal j : adminJObjs.getRev1Search(search)){
                            		  x++;%>
                                  <tr>
                                   <td>
                                          <%=x%>
