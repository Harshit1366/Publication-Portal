                     ...
                     <br><br><br><br><br><br><br>   <form method="post" action="#">
                        ...
                        <table class="table" border='1'>
                            ...
                            String search=request.getParameter("search");
                              ...
                              if(search==null){
                            	  for(Journal j : adminObjs.getAllEmployees()){
                            		  x++;
                            		  %>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                          <a href='../DownloadServlet?id=<%=j.getId()%>&type=journal'>Download</a>  
                                      </td>
                                      
                                      <td> 
                                          <a href='../Downloads?id=<%=j.getId()%>&type=journal'>Download</a>  
                                      </td>
                                      ...
                                      %>
                                          <a href='reject.jsp?id=<%=j.getId()%>&type=journal' onClick="return confirm('Are you sure you want to reject this application ?');">Reject</a> 
                                          <% }
