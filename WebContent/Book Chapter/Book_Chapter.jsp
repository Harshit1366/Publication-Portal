...
<a href="../Tech reports/Tech_Report.jsp">TECH REPORT <span class="badge"><%=(adminTRObjs.AllNewTR()+adminTRObjs.AllRev1TR()+adminTRObjs.AllRev2TR()) %></span></a><%} %></li>
     ...
     <li class="dropdown-header">  <%=n.getDiff() %> </li>
         ...
         <a href='../Delnote?id=<%=n.getId() %>&type=book_chapter'><p align='right'> <span class="glyphicon glyphicon-trash"> </span></p></a>
       </li>
          
           <li class="divider"></li>
          <%} %>
        </ul>
      </li>			<li><a href="../admin/Change_Password.jsp"> Change Password</a></li>   
                       ...
                       <%} %>
                        ...
                        <br>  <table class="table table-hover table-bordered">
                              ...
                              if(search==null && search2 == null){
                                  ...
                                  <tbody><%
                            	  for(Book_chapter b : adminBCObjs.getAllBook_Chap()){
                            		  x++;
                            		  %>
                                    ...
                                    <td>
                                      ...
                                      <td> 
                                       ...
                                       if(b.getStatus()!=null){
                                    	   ...
                                    	   <a href='../pcn?year=<%=b.getYear()%>&dept=<%=b.getDept()%>&id=<%=b.getId() %>&type=book_chapter' onClick="return confirm('Are you sure you want to generate pcn for this publication?');" >Generate PCN</a>
                                      <%} 
                                       %>
                             ...
                             <%}%></tbody>
                            	 ...
                            	 for(Book_chapter b : adminBCObjs.getSearch2(search2)){
                           		  x++;%>
                                  <tr>
                                     <td>
                                         <%=x%>
