                       ...
                       %><input type="text" name="search" size= '31' placeholder="Type author's name or PCN no." value=<%=search %>><%} %>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            //search=request.getParameter("search");
                              ...
                              if(search==null){
                            	  for(Patents p : adminPObjs.getNewPatent()){
                            		  x++;
                            		  %>
                            	  ...
                            	  //String search=request.getParameter("search");
                            	  for(Patents p : adminPObjs.getNewPatentSearch(search)){
                            		  x++;%>
                                  <tr>
                                      <td>
                                          <%=x%>
                                   ...
                                   <td>
                                      ...
                                      <td> 
                                       ...
                                       if(p.getStatus()!=null){
                                    	   ...
                                    	   <a href='../pcn?year=<%=p.getApplication_year()%>&dept=<%=p.getDept()%>&id=<%=p.getId() %>&type=Patent' onClick="return confirm('Are you sure you want to generate pcn for this publication?');" >Generate PCN</a>
                                      <%} 
                                       %>
